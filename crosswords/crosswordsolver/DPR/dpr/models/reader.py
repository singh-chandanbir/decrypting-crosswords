...
from crosswords.crosswordsolver.DPR.dpr.data.reader_data import ReaderSample, ReaderPassage
from crosswords.crosswordsolver.DPR.dpr.utils.model_utils import init_weights
